...
SOPCINFO_FILE := D:/DE2/nios_test/nios.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 591751049
SOPC_SYSID_FLAG += --id=591751049
ELF_PATCH_FLAG  += --id 591751049

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x10830
SOPC_SYSID_FLAG += --sidp=0x10830
ELF_PATCH_FLAG  += --sidp 0x10830

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1603543816
SOPC_SYSID_FLAG += --timestamp=1603543816
ELF_PATCH_FLAG  += --timestamp 1603543816
...
# setting hal.stderr is lcd_16207
ELF_PATCH_FLAG  += --stderr_dev lcd_16207

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is lcd_16207
ELF_PATCH_FLAG  += --stdin_dev lcd_16207
...
# setting hal.stdout is lcd_16207
ELF_PATCH_FLAG  += --stdout_dev lcd_16207
