...
$(MEM_0)_START := 0x00009000
$(MEM_0)_END := 0x000097ff
...
$(MEM_1)_HIERARCHICAL_PATH := ram_sys
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ram_sys
ram_sys: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
