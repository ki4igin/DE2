...
addfile -c -auto D:/DE2/sum/src/sum.vhd
addfile -c -auto D:/DE2/sum/src/sum_top.vhd

addfile -c -auto D:/DE2/sum/src/sum_top_tb.vhd
comp -reorder

asim +access +r -t 1ps -L sum_top -L work -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii  sum_top_tb
